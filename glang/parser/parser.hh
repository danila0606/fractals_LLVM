...
/**
 ** \file /mnt/c/Users/pc/Desktop/my_glang/parser/parser.hh
...
#ifndef YY_YY_MNT_C_USERS_PC_DESKTOP_MY_GLANG_PARSER_PARSER_HH_INCLUDED
# define YY_YY_MNT_C_USERS_PC_DESKTOP_MY_GLANG_PARSER_PARSER_HH_INCLUDED
// "%code requires" blocks.
#line 10 "/mnt/c/Users/pc/Desktop/my_glang/parser/parser.y"
...
#line 56 "/mnt/c/Users/pc/Desktop/my_glang/parser/parser.hh"
...
namespace yy {
#line 191 "/mnt/c/Users/pc/Desktop/my_glang/parser/parser.hh"
...
# if 201103L <= YY_CPLUSPLUS
  ...
  private:
    ...
    union union_type
    {
      ...
      // FUNCTION
      char dummy2[sizeof (std::shared_ptr<glang::DeclarationFuncNode>)];
      ...
      // while
      // return
      char dummy3[sizeof (std::shared_ptr<glang::Node>)];

      // global_scope
      // scope
      // begin_scope
      // end_scope
      char dummy4[sizeof (std::shared_ptr<glang::ScopeNode>)];
    ...
    INTEGER32_t = 259,             // INTEGER32_t
    WHILE = 260,                   // "while"
    RETURN = 261,                  // "return"
    IF = 262,                      // "if"
    FUNC = 263,                    // "func"
    MY_INT32_t = 264,              // "int32"
    SCOLON = 265,                  // ";"
    LCB = 266,                     // "{"
    RCB = 267,                     // "}"
    LRB = 268,                     // "("
    ...
    struct symbol_kind
    {
      enum symbol_kind_type
      {
        ...
        S_INTEGER32_t = 4,                       // INTEGER32_t
        S_WHILE = 5,                             // "while"
        S_RETURN = 6,                            // "return"
        S_IF = 7,                                // "if"
        S_FUNC = 8,                              // "func"
        S_MY_INT32_t = 9,                        // "int32"
        S_SCOLON = 10,                           // ";"
        S_LCB = 11,                              // "{"
        S_RCB = 12,                              // "}"
        S_LRB = 13,                              // "("
        ...
        switch (this->kind ())
    {
      ...
      case symbol_kind::S_FUNCTION: // FUNCTION
        value.move< std::shared_ptr<glang::DeclarationFuncNode> > (std::move (that.value));
        break;
      ...
      case symbol_kind::S_return: // return
        value.move< std::shared_ptr<glang::Node> > (std::move (that.value));
        break;
      ...
      case symbol_kind::S_end_scope: // end_scope
        value.move< std::shared_ptr<glang::ScopeNode> > (std::move (that.value));
        break;
...
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t, std::shared_ptr<glang::DeclarationFuncNode>&& v, location_type&& l)
        : Base (t)
        , value (std::move (v))
        , location (std::move (l))
      {}
#else
      basic_symbol (typename Base::kind_type t, const std::shared_ptr<glang::DeclarationFuncNode>& v, const location_type& l)
        : Base (t)
        , value (v)
        , location (l)
      {}
...
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t, std::shared_ptr<glang::Node>&& v, location_type&& l)
        : Base (t)
        , value (std::move (v))
        , location (std::move (l))
      {}
#else
      basic_symbol (typename Base::kind_type t, const std::shared_ptr<glang::Node>& v, const location_type& l)
        : Base (t)
        , value (v)
        , location (l)
      {}
...
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t, std::shared_ptr<glang::ScopeNode>&& v, location_type&& l)
        : Base (t)
        , value (std::move (v))
        , location (std::move (l))
      {}
#else
      basic_symbol (typename Base::kind_type t, const std::shared_ptr<glang::ScopeNode>& v, const location_type& l)
        : Base (t)
        , value (v)
        , location (l)
      {}
...
switch (yykind)
    {
      ...
      case symbol_kind::S_FUNCTION: // FUNCTION
        value.template destroy< std::shared_ptr<glang::DeclarationFuncNode> > ();
        break;
      ...
      case symbol_kind::S_while: // while
      case symbol_kind::S_return: // return
        value.template destroy< std::shared_ptr<glang::Node> > ();
        break;
      ...
      case symbol_kind::S_begin_scope: // begin_scope
      case symbol_kind::S_end_scope: // end_scope
        value.template destroy< std::shared_ptr<glang::ScopeNode> > ();
        break;
    ...
    // Implementation of make_symbol for each token kind.
      ...
      static
      symbol_type
      make_INTEGER32_t (int v, location_type l)
      {
        return symbol_type (token::INTEGER32_t, std::move (v), std::move (l));
      }
#else
      static
      symbol_type
      make_INTEGER32_t (const int& v, const location_type& l)
      {
        return symbol_type (token::INTEGER32_t, v, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      ...
      static
      symbol_type
      make_MY_INT32_t (location_type l)
      {
        return symbol_type (token::MY_INT32_t, std::move (l));
      }
#else
      static
      symbol_type
      make_MY_INT32_t (const location_type& l)
      {
        return symbol_type (token::MY_INT32_t, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      ...
      static
      symbol_type
      make_LAB (location_type l)
      {
        return symbol_type (token::LAB, std::move (l));
      }
#else
      static
      symbol_type
      make_LAB (const location_type& l)
      {
        return symbol_type (token::LAB, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      symbol_type
      make_RAB (location_type l)
      {
        return symbol_type (token::RAB, std::move (l));
      }
#else
      static
      symbol_type
      make_RAB (const location_type& l)
      {
        return symbol_type (token::RAB, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
...
#endif // !YY_YY_MNT_C_USERS_PC_DESKTOP_MY_GLANG_PARSER_PARSER_HH_INCLUDED
